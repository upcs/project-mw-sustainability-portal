...
import * as better_call244 from "better-call";
...
declare const nextCookies: () => {
  ...
  hooks: {
    after: {
      matcher(ctx: _better_auth_core12.HookEndpointContext): true;
      handler: (inputContext: better_call244.MiddlewareInputContext<better_call244.MiddlewareOptions>) => Promise<void>;
    }[];
  };
};
//#endregion
