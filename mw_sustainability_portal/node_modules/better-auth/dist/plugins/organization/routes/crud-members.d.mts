...
import * as _better_auth_core_db163 from "@better-auth/core/db";
import * as better_call981 from "better-call";
import * as z from "zod";

//#region src/plugins/organization/routes/crud-members.d.ts
declare const addMember: <O extends OrganizationOptions>(option: O) => better_call981.StrictEndpoint<string, {
  method: "POST";
  body: z.ZodObject<{
  ...
  use: ((inputContext: better_call981.MiddlewareInputContext<better_call981.MiddlewareOptions>) => Promise<{
    ...
    getSession: (context: _better_auth_core68.GenericEndpointContext) => Promise<{
      session: _better_auth_core_db163.Session & {
        activeTeamId?: string | undefined;
        activeOrganizationId?: string | undefined;
      };
      user: _better_auth_core_db163.User;
    }>;
  }>)[];
  metadata: {
    $Infer: {
...
declare const removeMember: <O extends OrganizationOptions>(options: O) => better_call981.StrictEndpoint<"/organization/remove-member", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call981.MiddlewareInputContext<{
    use: ((inputContext: better_call981.MiddlewareInputContext<better_call981.MiddlewareOptions>) => Promise<{
      session: {
  ...
  member: (O["teams"] extends {
    ...
    member?: {
      additionalFields: infer Field extends Record<string, _better_auth_core_db163.DBFieldAttribute>;
    } | undefined;
  } ? FieldAttributeToObject<RemoveFieldsWithReturnedFalse<Field>> : {}) extends infer T ? { [K in keyof T]: T[K] } : never;
} | null>;
declare const updateMemberRole: <O extends OrganizationOptions>(option: O) => better_call981.StrictEndpoint<"/organization/update-member-role", {
  method: "POST";
  body: z.ZodObject<{
    role: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
...
declare const getActiveMember: <O extends OrganizationOptions>(options: O) => better_call981.StrictEndpoint<"/organization/get-active-member", {
  method: "GET";
  use: (((inputContext: better_call981.MiddlewareInputContext<better_call981.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const leaveOrganization: <O extends OrganizationOptions>(options: O) => better_call981.StrictEndpoint<"/organization/leave", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call981.MiddlewareInputContext<better_call981.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
      [key: string]: Role<{}>;
    };
...
declare const listMembers: <O extends OrganizationOptions>(options: O) => better_call981.StrictEndpoint<"/organization/list-members", {
  method: "GET";
...
declare const getActiveMemberRole: <O extends OrganizationOptions>(options: O) => better_call981.StrictEndpoint<"/organization/get-active-member-role", {
  method: "GET";
  query: z.ZodOptional<z.ZodObject<{
